export const Navbar = (currentPath) => {
    ...
    const homeClass = isActive('home-2.html') ? 'active' : '';
    ...
    const aiClass = isActive('ai.html') ? 'active' : '';
    ...
    return `
        ...
        <div class="navbar" id="navbar">
            ...
            <div class="nav-item ${homeClass}" data-path="home-2.html">
            ...
            <div class="nav-item ${aiClass}" data-path="ai.html">
